...
private:
	...
	const float JUMP_RESET = 100.0f;	// Reset the jump speed
	const float ROTATE = 240.0f; // Rotates the cube round when double jumping
	const float PLAYER_SPEED = 50.0f; // The speed of the player
	...
	// Collision Controls
	const float HEIGHT = 10.0f; // Height of the model
	const float WIDTH = 10.0f; // Width of the model
